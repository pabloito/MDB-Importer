...
COPY calendar_dates(service_id,date,exception_type) from 'calendar_dates.txt' DELIMITER ',' CSV HEADER;
COPY stop_times(trip_id,arrival_time,departure_time,stop_id,stop_sequence) from 'stop_times.txt' DELIMITER ',' CSV HEADER;
COPY trips(route_id,service_id,trip_id,shape_id) from 'trips.txt' DELIMITER ',' CSV HEADER;
COPY shapes(shape_id,shape_pt_lat,shape_pt_lon,shape_pt_sequence) from 'shapes.txt' DELIMITER ',' CSV HEADER;
COPY stops(stop_id,stop_lat,stop_lon) from 'stops.txt' DELIMITER ',' CSV HEADER;
